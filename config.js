exports.creds = {
  // Required
  identityMetadata: 'https://login.microsoftonline.com/hjmownit.onmicrosoft.com/v2.0/.well-known/openid-configuration', 
  ...
  clientID: '6987a0d2-b25f-4b29-bad8-19e9f946b74e',
  ...
  redirectUrl: 'https://193.11.185.46:3000/scheme', 
  ...
  clientSecret: '.4~1KqK6c95y~sx.412w~mKUKThH03S1y2', 
  ...
  scope: ['profile', 'email', 'offline_access', "user.read", "calendars.read"],
...
exports.destroySessionUrl = 'https://login.microsoftonline.com/common/oauth2/logout?post_logout_redirect_uri=http://193.11.185.46:3000/scheme';
